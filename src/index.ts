...
//
// Bet Worker V7.2 remains the ONLY authority for BET READY.
...
async function getBetReadyForHunter(
  ...
  try {
    ...
    if (readyRow) {
      ...
      // Final authoritative flag from Bet Worker.
      const ready =
    ...
    return {
      ...
      reason:
        "EVENT_NOT_RETURNED_BY_BET_WORKER",
